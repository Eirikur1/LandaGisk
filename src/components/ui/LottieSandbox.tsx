...
import animationData from "@/assets/lottie/AnimatedMonkey.json";

const LEFT_FADE =
  "linear-gradient(to right, var(--color-background) 0%, var(--color-background) 28%, transparent 100%)";

export default function LottieSandbox() {
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          top: "50%",
          transform: ready
            ? "translateY(-30%) translateX(min(18vw, 10rem))"
            : "translateY(20%) translateX(100vw)",
          opacity: ready ? 1 : 0,
